...
/* harmony import */ var _microsoft_applicationinsights_core_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! @microsoft/applicationinsights-core-js */ "./node_modules/@microsoft/applicationinsights-core-js/dist-esm/JavaScriptSDK/AppInsightsCore.js");
/* harmony import */ var _Utils__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./Utils */ "./node_modules/@microsoft/1ds-core-js/dist-esm/src/Utils.js");
            ...
            _self.initialize = function (config, extensions, logger, notificationManager) {
                (0,_microsoft_applicationinsights_core_js__WEBPACK_IMPORTED_MODULE_3__.doPerf)(_self, function () { return "AppInsightsCore.initialize"; }, function () {
                    ...
                    if (config) {
                        ...
                        if (config.channels) {
                            (0,_microsoft_applicationinsights_core_js__WEBPACK_IMPORTED_MODULE_4__.arrForEach)(config.channels, function (channels) {
                                if (channels) {
                                    (0,_microsoft_applicationinsights_core_js__WEBPACK_IMPORTED_MODULE_4__.arrForEach)(channels, function (channel) {
                    ...
                    if (extensions) {
                        (0,_microsoft_applicationinsights_core_js__WEBPACK_IMPORTED_MODULE_4__.arrForEach)(extensions, function (ext) {
                    ...
                    try {
                        ...
                        var message = (0,_microsoft_applicationinsights_core_js__WEBPACK_IMPORTED_MODULE_5__.dumpObj)(e);
            ...
            _self.track = function (item) {
                (0,_microsoft_applicationinsights_core_js__WEBPACK_IMPORTED_MODULE_3__.doPerf)(_self, function () { return "AppInsightsCore.track"; }, function () {
                    ...
                    if (telemetryItem) {
                        ...
                        telemetryItem.timings.trackStart = (0,_Utils__WEBPACK_IMPORTED_MODULE_6__.getTime)();
                        if (!(0,_Utils__WEBPACK_IMPORTED_MODULE_6__.isLatency)(telemetryItem.latency)) {
                            telemetryItem.latency = 1 /* EventLatencyValue.Normal */;
                        }
                        var itemExt = telemetryItem.ext = telemetryItem.ext || {};
                        itemExt.sdk = itemExt.sdk || {};
                        itemExt.sdk.ver = _Utils__WEBPACK_IMPORTED_MODULE_6__.FullVersionString;
...
}(_microsoft_applicationinsights_core_js__WEBPACK_IMPORTED_MODULE_7__.AppInsightsCore));
...
/* harmony import */ var _microsoft_applicationinsights_core_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @microsoft/applicationinsights-core-js */ "./node_modules/@microsoft/applicationinsights-core-js/dist-esm/JavaScriptSDK/BaseCore.js");
    ...
    function BaseCore() {
        ...
        (0,_microsoft_dynamicproto_js__WEBPACK_IMPORTED_MODULE_1__["default"])(BaseCore, _this, function (_self, _base) {
            _self.initialize = function (config, extensions, logger, notificationManager) {
                ...
                _self.getWParam = function () {
                    return _Utils__WEBPACK_IMPORTED_MODULE_2__.isDocumentObjectAvailable ? 0 : -1;
                };
                try {
                    _base.initialize(config, extensions, logger, notificationManager);
                }
                catch (e) {
                    (0,_microsoft_applicationinsights_core_js__WEBPACK_IMPORTED_MODULE_3__._throwInternal)(_self.logger, 1 /* eLoggingSeverity.CRITICAL */, 514 /* _eExtendedInternalMessageId.FailedToInitializeSDK */, "Initialization Failed: " + (0,_microsoft_applicationinsights_core_js__WEBPACK_IMPORTED_MODULE_4__.dumpObj)(e) + "\n - Note: Channels must be provided through config.channels only");
                }
            };
            _self.track = function (item) {
                var telemetryItem = item;
                if (telemetryItem) {
                    ...
                    ext.sdk = ext.sdk || {};
                    ext.sdk.ver = _Utils__WEBPACK_IMPORTED_MODULE_2__.FullVersionString;
                }
                _base.track(telemetryItem);
            };
        });
...
// Removed Stub for BaseCore.prototype.track.
    return BaseCore;
}(_microsoft_applicationinsights_core_js__WEBPACK_IMPORTED_MODULE_5__.BaseCore));
...
/* harmony export */ });
/* harmony import */ var _microsoft_applicationinsights_core_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @microsoft/applicationinsights-core-js */ "./node_modules/@microsoft/applicationinsights-core-js/dist-esm/JavaScriptSDK/HelperFuncs.js");
/* harmony import */ var _Utils__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Utils */ "./node_modules/@microsoft/1ds-core-js/dist-esm/src/Utils.js");
/*
 * 1DS JS SDK Core, 3.2.3
 * Copyright (c) Microsoft and contributors. All rights reserved.
 * (Microsoft Internal Only)
...
var ValueSanitizer = /** @class */ (function () {
    function ValueSanitizer(fieldSanitizerProvider) {
        ...
        _self.value = function (path, name, value, stringifyObjects) {
            ...
            if (mapValue && mapValue.canHandle) {
                ...
                if (!(0,_microsoft_applicationinsights_core_js__WEBPACK_IMPORTED_MODULE_0__.isString)(name) || (0,_microsoft_applicationinsights_core_js__WEBPACK_IMPORTED_MODULE_0__.isNullOrUndefined)(value) || value === "") {
                    return null;
                }
                var property = null;
                var fieldType = (0,_Utils__WEBPACK_IMPORTED_MODULE_1__.getFieldValueType)(value);
                if ((fieldType & 8192 /* FieldValueSanitizerType.EventProperty */) === 8192 /* FieldValueSanitizerType.EventProperty */) {
                    ...
                    property = value;
                    if (!(0,_Utils__WEBPACK_IMPORTED_MODULE_1__.isValueAssigned)(property.value) ||
        ...
        _self.property = function (path, name, property, stringifyObjects) {
            ...
            // Check that property is valid
            if (!(0,_microsoft_applicationinsights_core_js__WEBPACK_IMPORTED_MODULE_0__.isString)(name) || (0,_microsoft_applicationinsights_core_js__WEBPACK_IMPORTED_MODULE_0__.isNullOrUndefined)(property) || !(0,_Utils__WEBPACK_IMPORTED_MODULE_1__.isValueAssigned)(property.value)) {
                return null;
            }
            var fieldType = (0,_Utils__WEBPACK_IMPORTED_MODULE_1__.getFieldValueType)(property.value);
        ...
        function _handleProperty(mapValue, path, name, fieldType, property, stringifyObjects) {
            ...
            if (!(0,_microsoft_applicationinsights_core_js__WEBPACK_IMPORTED_MODULE_0__.isNullOrUndefined)(property.kind)) {
                if ((fieldType & 4096 /* FieldValueSanitizerType.Array */) === 4096 /* FieldValueSanitizerType.Array */ || !(0,_Utils__WEBPACK_IMPORTED_MODULE_1__.isValueKind)(property.kind)) {
                    return null;
                }
        ...
        function _convertToProperty(path, name, value) {
            if ((0,_Utils__WEBPACK_IMPORTED_MODULE_1__.isValueAssigned)(value)) {
                return { value: value };
            }
            return null;
        }
                ...
                if (sanitizer) {
                    ...
                    if (theType === 4 /* FieldValueSanitizerType.Object */) {
                        ...
                        (0,_microsoft_applicationinsights_core_js__WEBPACK_IMPORTED_MODULE_0__.objForEachKey)(propValue, function (propKey, theValue) {
                            ...
                            if ((0,_Utils__WEBPACK_IMPORTED_MODULE_1__.isValueAssigned)(theValue)) {
                                var newProp = _convertToProperty(newPath, propKey, theValue);
                                newProp = _callFieldSanitizer(fieldProvider, newPath, propKey, (0,_Utils__WEBPACK_IMPORTED_MODULE_1__.getFieldValueType)(theValue), newProp);
                                if (newProp) {
    ...
    ValueSanitizer.getFieldType = _Utils__WEBPACK_IMPORTED_MODULE_1__.getFieldValueType;
 ...
 */
var _InternalMessageId = (0,_JavaScriptSDK_Enums_EnumHelperFuncs__WEBPACK_IMPORTED_MODULE_0__.createEnumStyle)({
    // Non user actionable
...
/* harmony export */ });
/* harmony import */ var _microsoft_applicationinsights_shims__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @microsoft/applicationinsights-shims */ "./node_modules/@microsoft/applicationinsights-shims/dist-esm/TsLibShims.js");
/* harmony import */ var _BaseCore__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./BaseCore */ "./node_modules/@microsoft/applicationinsights-core-js/dist-esm/JavaScriptSDK/BaseCore.js");
        ...
        (0,_microsoft_dynamicproto_js__WEBPACK_IMPORTED_MODULE_1__["default"])(AppInsightsCore, _this, function (_self, _base) {
            ...
            function _validateTelemetryItem(telemetryItem) {
                if ((0,_HelperFuncs__WEBPACK_IMPORTED_MODULE_5__.isNullOrUndefined)(telemetryItem.name)) {
                    _notifyInvalidEvent(telemetryItem);
                    (0,_HelperFuncs__WEBPACK_IMPORTED_MODULE_5__.throwError)("telemetry name required");
                }
            }
...
// Removed Stub for AppInsightsCore.prototype.track.
    return AppInsightsCore;
}(_BaseCore__WEBPACK_IMPORTED_MODULE_6__.BaseCore));
...
/* harmony export */ });
/* harmony import */ var _microsoft_applicationinsights_shims__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! @microsoft/applicationinsights-shims */ "./node_modules/@microsoft/applicationinsights-shims/dist-esm/TsLibShims.js");
...
/* harmony import */ var _microsoft_dynamicproto_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @microsoft/dynamicproto-js */ "./node_modules/@microsoft/dynamicproto-js/lib/dist/esm/dynamicproto-js.js");
...
function _validateExtensions(logger, channelPriority, allExtensions) {
    ...
    (0,_HelperFuncs__WEBPACK_IMPORTED_MODULE_1__.arrForEach)(allExtensions, function (ext) {
        if ((0,_HelperFuncs__WEBPACK_IMPORTED_MODULE_1__.isNullOrUndefined)(ext) || (0,_HelperFuncs__WEBPACK_IMPORTED_MODULE_1__.isNullOrUndefined)(ext.initialize)) {
        ...
        if (ext && extPriority) {
            if (!(0,_HelperFuncs__WEBPACK_IMPORTED_MODULE_1__.isNullOrUndefined)(extPriorities[extPriority])) {
                (0,_DiagnosticLogger__WEBPACK_IMPORTED_MODULE_2__._warnToConsole)(logger, "Two extensions have same priority #" + extPriority + " - " + extPriorities[extPriority] + ", " + identifier);
            }
            else {
                // set a value
...
function _createDummyNotificationManager() {
    var _a;
    return (0,_microsoft_applicationinsights_shims__WEBPACK_IMPORTED_MODULE_3__.objCreateFn)((_a = {},
        _a[_InternalConstants__WEBPACK_IMPORTED_MODULE_4__.strAddNotificationListener] = function (listener) { },
        _a[_InternalConstants__WEBPACK_IMPORTED_MODULE_4__.strRemoveNotificationListener] = function (listener) { },
        _a[_InternalConstants__WEBPACK_IMPORTED_MODULE_4__.strEventsSent] = function (events) { },
        _a[_InternalConstants__WEBPACK_IMPORTED_MODULE_4__.strEventsDiscarded] = function (events, reason) { },
        _a[_InternalConstants__WEBPACK_IMPORTED_MODULE_4__.strEventsSendRequest] = function (sendReason, isAsync) { },
        _a));
}
var BaseCore = /** @class */ (function () {
    function BaseCore() {
        ...
        (0,_microsoft_dynamicproto_js__WEBPACK_IMPORTED_MODULE_5__["default"])(BaseCore, this, function (_self) {
            ...
            _self.initialize = function (config, extensions, logger, notificationManager) {
                ...
                if (!config || (0,_HelperFuncs__WEBPACK_IMPORTED_MODULE_1__.isNullOrUndefined)(config.instrumentationKey)) {
                ...
                config.extensions = (0,_HelperFuncs__WEBPACK_IMPORTED_MODULE_1__.isNullOrUndefined)(config.extensions) ? [] : config.extensions;
                ...
                // Extension validation
                _configExtensions = [];
                _configExtensions.push.apply(_configExtensions, (0,_microsoft_applicationinsights_shims__WEBPACK_IMPORTED_MODULE_6__.__spreadArrayFn)((0,_microsoft_applicationinsights_shims__WEBPACK_IMPORTED_MODULE_6__.__spreadArrayFn)([], extensions, false), config.extensions, false));
                _channelConfig = (config || {}).channels;
                _initPluginChain(config, null);
                if (!_channelQueue || _channelQueue.length === 0) {
                    (0,_HelperFuncs__WEBPACK_IMPORTED_MODULE_1__.throwError)("No channels available");
                }
                _isInitialized = true;
                _self.releaseQueue();
            };
            ...
            _self.track = function (telemetryItem) {
                ...
                (0,_HelperFuncs__WEBPACK_IMPORTED_MODULE_1__.setValue)(telemetryItem, _Constants__WEBPACK_IMPORTED_MODULE_7__.strIKey, _self.config.instrumentationKey, null, _HelperFuncs__WEBPACK_IMPORTED_MODULE_1__.isNotTruthy);
                // add default timestamp if not passed in
                (0,_HelperFuncs__WEBPACK_IMPORTED_MODULE_1__.setValue)(telemetryItem, "time", (0,_HelperFuncs__WEBPACK_IMPORTED_MODULE_1__.toISOString)(new Date()), null, _HelperFuncs__WEBPACK_IMPORTED_MODULE_1__.isNotTruthy);
                // Common Schema 4.0
                (0,_HelperFuncs__WEBPACK_IMPORTED_MODULE_1__.setValue)(telemetryItem, "ver", "4.0", null, _HelperFuncs__WEBPACK_IMPORTED_MODULE_1__.isNullOrUndefined);
             ...
             */
            _self[_InternalConstants__WEBPACK_IMPORTED_MODULE_4__.strAddNotificationListener] = function (listener) {
                if (_notificationManager) {
                    _notificationManager[_InternalConstants__WEBPACK_IMPORTED_MODULE_4__.strAddNotificationListener](listener);
                }
            };
            /**
             ...
             */
            _self[_InternalConstants__WEBPACK_IMPORTED_MODULE_4__.strRemoveNotificationListener] = function (listener) {
                if (_notificationManager) {
                    _notificationManager[_InternalConstants__WEBPACK_IMPORTED_MODULE_4__.strRemoveNotificationListener](listener);
                }
            };
            _self.getCookieMgr = function () {
                if (!_cookieManager) {
                    _cookieManager = (0,_CookieMgr__WEBPACK_IMPORTED_MODULE_8__.createCookieMgr)(_self.config, _self.logger);
                }
            ...
            _self.getPerfMgr = function () {
                if (!_perfManager && !_cfgPerfManager) {
                    if (_self.config && _self.config.enablePerfMgr && (0,_HelperFuncs__WEBPACK_IMPORTED_MODULE_1__.isFunction)(_self.config.createPerfMgr)) {
            ...
            function _initDefaults() {
                ...
                _self.config = (0,_HelperFuncs__WEBPACK_IMPORTED_MODULE_1__.objExtend)(true, {}, defaultInitConfig);
                _self.logger = new _DiagnosticLogger__WEBPACK_IMPORTED_MODULE_2__.DiagnosticLogger(_self.config);
                _self._extensions = [];
            ...
            function _createTelCtx() {
                return (0,_ProcessTelemetryContext__WEBPACK_IMPORTED_MODULE_9__.createProcessTelemetryContext)(_getPluginChain(), _self.config, _self);
            }
            // Initialize or Re-initialize the plugins
            function _initPluginChain(config, updateState) {
                // Extension validation
                var theExtensions = _validateExtensions(_self.logger, _ChannelController__WEBPACK_IMPORTED_MODULE_14__.ChannelControllerPriority, _configExtensions);
                _coreExtensions = theExtensions.core;
                _pluginChain = null;
                // Sort the complete set of extensions by priority
                var allExtensions = theExtensions.all;
                // Initialize the Channel Queues and the channel plugins first
                _channelQueue = (0,_HelperFuncs__WEBPACK_IMPORTED_MODULE_1__.objFreeze)((0,_ChannelController__WEBPACK_IMPORTED_MODULE_14__.createChannelQueues)(_channelConfig, allExtensions, config, _self));
                if (_channelControl) {
                ...
                _self._extensions = (0,_TelemetryHelpers__WEBPACK_IMPORTED_MODULE_10__.sortPlugins)(allExtensions);
                ...
                _self._extensions = (0,_HelperFuncs__WEBPACK_IMPORTED_MODULE_1__.objFreeze)((0,_TelemetryHelpers__WEBPACK_IMPORTED_MODULE_10__.sortPlugins)(_coreExtensions || [])).slice();
                if (updateState) {
            ...
            function _getPlugin(pluginIdentifier) {
                var theExt = null;
                var thePlugin = null;
                (0,_HelperFuncs__WEBPACK_IMPORTED_MODULE_1__.arrForEach)(_self._extensions, function (ext) {
                ...
                if (thePlugin) {
                    theExt = {
                        ...
                        setEnabled: function (enabled) {
                            (0,_TelemetryHelpers__WEBPACK_IMPORTED_MODULE_10__._getPluginState)(thePlugin)[_InternalConstants__WEBPACK_IMPORTED_MODULE_4__.strDisabled] = !enabled;
                        },
                        isEnabled: function () {
                            var pluginState = (0,_TelemetryHelpers__WEBPACK_IMPORTED_MODULE_10__._getPluginState)(thePlugin);
                            return !pluginState[_InternalConstants__WEBPACK_IMPORTED_MODULE_4__.strTeardown] && !pluginState[_InternalConstants__WEBPACK_IMPORTED_MODULE_4__.strDisabled];
                        },
            ...
            function _getPluginChain() {
                if (!_pluginChain) {
                    ...
                    _pluginChain = (0,_ProcessTelemetryContext__WEBPACK_IMPORTED_MODULE_9__.createTelemetryProxyChain)((0,_TelemetryHelpers__WEBPACK_IMPORTED_MODULE_10__.sortPlugins)(extensions), _self.config, _self);
                }
                return _pluginChain;
            }
            function _removePlugins(thePlugins, unloadState, removeComplete) {
                if (thePlugins && thePlugins.length > 0) {
                    var unloadChain = (0,_ProcessTelemetryContext__WEBPACK_IMPORTED_MODULE_9__.createTelemetryProxyChain)(thePlugins, _self.config, _self);
                ...
                if (queue) {
                    (0,_HelperFuncs__WEBPACK_IMPORTED_MODULE_1__.arrForEach)(queue, function (logMessage) {
                        var item = {
                            ...
                            time: (0,_HelperFuncs__WEBPACK_IMPORTED_MODULE_1__.toISOString)(new Date()),
            ...
            function _initDebugListener(config) {
                if (config.disableDbgExt === true && _debugListener) {
                    ...
                    _notificationManager[_InternalConstants__WEBPACK_IMPORTED_MODULE_4__.strRemoveNotificationListener](_debugListener);
                    _debugListener = null;
                }
                if (_notificationManager && !_debugListener && config.disableDbgExt !== true) {
                    _debugListener = (0,_DbgExtensionUtils__WEBPACK_IMPORTED_MODULE_15__.getDebugListener)(config);
                    _notificationManager[_InternalConstants__WEBPACK_IMPORTED_MODULE_4__.strAddNotificationListener](_debugListener);
                }
            }
            function _initPerfManager(config) {
                ...
                if (config.enablePerfMgr) {
                    ...
                    (0,_HelperFuncs__WEBPACK_IMPORTED_MODULE_1__.setValue)(_self.config, "createPerfMgr", _createPerfManager);
                }
            }
            function _initExtConfig(config) {
                var extConfig = (0,_HelperFuncs__WEBPACK_IMPORTED_MODULE_1__.getSetValue)(config, _Constants__WEBPACK_IMPORTED_MODULE_7__.strExtensionConfig);
            ...
            function _logOrThrowError(message) {
                ...
                if (logger) {
                    ...
                    (0,_DiagnosticLogger__WEBPACK_IMPORTED_MODULE_2__._throwInternal)(logger, 2 /* eLoggingSeverity.WARNING */, 73 /* _eInternalMessageId.PluginException */, message);
                }
                else {
...
function _addChannelQueue(channelQueue, queue, config, core) {
    if (queue && (0,_HelperFuncs__WEBPACK_IMPORTED_MODULE_0__.isArray)(queue) && queue.length > 0) {
        queue = queue.sort(function (a, b) {
            return a.priority - b.priority;
        });
        (0,_HelperFuncs__WEBPACK_IMPORTED_MODULE_0__.arrForEach)(queue, function (queueItem) {
            if (queueItem.priority < ChannelControllerPriority) {
                (0,_HelperFuncs__WEBPACK_IMPORTED_MODULE_0__.throwError)(ChannelValidationMessage + queueItem.identifier);
            }
        });
        channelQueue.push({
            queue: (0,_HelperFuncs__WEBPACK_IMPORTED_MODULE_0__.objFreeze)(queue),
            chain: (0,_ProcessTelemetryContext__WEBPACK_IMPORTED_MODULE_1__.createTelemetryProxyChain)(queue, config, core)
        });
    }
}
function createChannelControllerPlugin(channelQueue, core) {
    var _a;
    function _getTelCtx() {
        return (0,_ProcessTelemetryContext__WEBPACK_IMPORTED_MODULE_1__.createProcessTelemetryContext)(null, core.config, core, null);
    }
    ...
    function _doUpdate(updateCtx, updateState) {
        ...
        _processChannelQueue(channelQueue, updateCtx, function (chainCtx) {
            chainCtx[_InternalConstants__WEBPACK_IMPORTED_MODULE_2__.strProcessNext](theUpdateState);
        }, function () {
            updateCtx[_InternalConstants__WEBPACK_IMPORTED_MODULE_2__.strProcessNext](theUpdateState);
        });
        return true;
    }
    function _doTeardown(unloadCtx, unloadState) {
        ...
        _processChannelQueue(channelQueue, unloadCtx, function (chainCtx) {
            chainCtx[_InternalConstants__WEBPACK_IMPORTED_MODULE_2__.strProcessNext](theUnloadState);
        }, function () {
            unloadCtx[_InternalConstants__WEBPACK_IMPORTED_MODULE_2__.strProcessNext](theUnloadState);
            isInitialized = false;
        });
        return true;
    }
    ...
    var channelController = (_a = {
            ...
            initialize: function (config, core, extensions, pluginChain) {
                ...
                (0,_HelperFuncs__WEBPACK_IMPORTED_MODULE_0__.arrForEach)(channelQueue, function (channels) {
                    if (channels && channels.queue.length > 0) {
                        (0,_TelemetryHelpers__WEBPACK_IMPORTED_MODULE_3__.initializePlugins)((0,_ProcessTelemetryContext__WEBPACK_IMPORTED_MODULE_1__.createProcessTelemetryContext)(channels.chain, config, core), extensions);
                    }
                });
            },
            ...
            processTelemetry: function (item, itemCtx) {
                _processChannelQueue(channelQueue, itemCtx || _getTelCtx(), function (chainCtx) {
                    chainCtx[_InternalConstants__WEBPACK_IMPORTED_MODULE_2__.strProcessNext](item);
                }, function () {
                    itemCtx[_InternalConstants__WEBPACK_IMPORTED_MODULE_2__.strProcessNext](item);
                });
            },
            update: _doUpdate
        },
        _a[_InternalConstants__WEBPACK_IMPORTED_MODULE_2__.strPause] = function () {
            _processChannelQueue(channelQueue, _getTelCtx(), function (chainCtx) {
                chainCtx.iterate(function (plugin) {
                    plugin[_InternalConstants__WEBPACK_IMPORTED_MODULE_2__.strPause] && plugin[_InternalConstants__WEBPACK_IMPORTED_MODULE_2__.strPause]();
                });
            }, null);
        },
        _a[_InternalConstants__WEBPACK_IMPORTED_MODULE_2__.strResume] = function () {
            _processChannelQueue(channelQueue, _getTelCtx(), function (chainCtx) {
                chainCtx.iterate(function (plugin) {
                    plugin[_InternalConstants__WEBPACK_IMPORTED_MODULE_2__.strResume] && plugin[_InternalConstants__WEBPACK_IMPORTED_MODULE_2__.strResume]();
                });
            }, null);
        },
        _a[_InternalConstants__WEBPACK_IMPORTED_MODULE_2__.strTeardown] = _doTeardown,
...
function createChannelQueues(channels, extensions, config, core) {
    ...
    if (channels) {
        ...
        (0,_HelperFuncs__WEBPACK_IMPORTED_MODULE_0__.arrForEach)(channels, function (queue) { return _addChannelQueue(channelQueue, queue, config, core); });
    }
    if (extensions) {
...
var NotificationManager = /** @class */ (function () {
    function NotificationManager(config) {
        ...
        (0,_microsoft_dynamicproto_js__WEBPACK_IMPORTED_MODULE_1__["default"])(NotificationManager, this, function (_self) {
            _self[_InternalConstants__WEBPACK_IMPORTED_MODULE_2__.strAddNotificationListener] = function (listener) {
             ...
             */
            _self[_InternalConstants__WEBPACK_IMPORTED_MODULE_2__.strRemoveNotificationListener] = function (listener) {
                var index = (0,_HelperFuncs__WEBPACK_IMPORTED_MODULE_0__.arrIndexOf)(_self.listeners, listener);
                while (index > -1) {
                    _self.listeners.splice(index, 1);
                    index = (0,_HelperFuncs__WEBPACK_IMPORTED_MODULE_0__.arrIndexOf)(_self.listeners, listener);
                }
            };
            /**
             ...
             */
            _self[_InternalConstants__WEBPACK_IMPORTED_MODULE_2__.strEventsSent] = function (events) {
                _runListeners(_self.listeners, _InternalConstants__WEBPACK_IMPORTED_MODULE_2__.strEventsSent, true, function (listener) {
                    listener[_InternalConstants__WEBPACK_IMPORTED_MODULE_2__.strEventsSent](events);
                });
            };
            /**
             ...
             */
            _self[_InternalConstants__WEBPACK_IMPORTED_MODULE_2__.strEventsDiscarded] = function (events, reason) {
                _runListeners(_self.listeners, _InternalConstants__WEBPACK_IMPORTED_MODULE_2__.strEventsDiscarded, true, function (listener) {
                    listener[_InternalConstants__WEBPACK_IMPORTED_MODULE_2__.strEventsDiscarded](events, reason);
                });
            };
            /**
             ...
             */
            _self[_InternalConstants__WEBPACK_IMPORTED_MODULE_2__.strEventsSendRequest] = function (sendReason, isAsync) {
                _runListeners(_self.listeners, _InternalConstants__WEBPACK_IMPORTED_MODULE_2__.strEventsSendRequest, isAsync, function (listener) {
                    listener[_InternalConstants__WEBPACK_IMPORTED_MODULE_2__.strEventsSendRequest](sendReason, isAsync);
                });
            };
            _self[_InternalConstants__WEBPACK_IMPORTED_MODULE_2__.strPerfEvent] = function (perfEvent) {
                if (perfEvent) {
                    // Send all events or only parent events
                    if (perfEvtsSendAll || !perfEvent.isChildEvt()) {
                        _runListeners(_self.listeners, _InternalConstants__WEBPACK_IMPORTED_MODULE_2__.strPerfEvent, false, function (listener) {
                            if (perfEvent.isAsync) {
                                setTimeout(function () { return listener[_InternalConstants__WEBPACK_IMPORTED_MODULE_2__.strPerfEvent](perfEvent); }, 0);
                            }
                            else {
                                listener[_InternalConstants__WEBPACK_IMPORTED_MODULE_2__.strPerfEvent](perfEvent);
                            }
                        });
                    }
                }
...
/* harmony import */ var _microsoft_applicationinsights_shims__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @microsoft/applicationinsights-shims */ "./node_modules/@microsoft/applicationinsights-shims/dist-esm/TsLibShims.js");
/* harmony import */ var _microsoft_dynamicproto_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @microsoft/dynamicproto-js */ "./node_modules/@microsoft/dynamicproto-js/lib/dist/esm/dynamicproto-js.js");
/* harmony import */ var _BaseTelemetryPlugin__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./BaseTelemetryPlugin */ "./node_modules/@microsoft/applicationinsights-core-js/dist-esm/JavaScriptSDK/BaseTelemetryPlugin.js");
    ...
    function TelemetryInitializerPlugin() {
        ...
        (0,_microsoft_dynamicproto_js__WEBPACK_IMPORTED_MODULE_1__["default"])(TelemetryInitializerPlugin, _this, function (_self, _base) {
            _self.addTelemetryInitializer = function (telemetryInitializer) {
                ...
                var handler = {
                    remove: function () {
                        (0,_HelperFuncs__WEBPACK_IMPORTED_MODULE_2__.arrForEach)(_initializers, function (initializer, idx) {
                ...
                for (var i = 0; i < telemetryInitializersCount; ++i) {
                    ...
                    if (telemetryInitializer) {
                        try {
                            ...
                            // doNotSendItem = true;
                            (0,_DiagnosticLogger__WEBPACK_IMPORTED_MODULE_3__._throwInternal)(itemCtx.diagLog(), 1 /* eLoggingSeverity.CRITICAL */, 64 /* _eInternalMessageId.TelemetryInitializerFailed */, "One of telemetry initializers failed, telemetry item will not be sent: " + (0,_HelperFuncs__WEBPACK_IMPORTED_MODULE_2__.getExceptionName)(e), { exception: (0,_EnvUtils__WEBPACK_IMPORTED_MODULE_4__.dumpObj)(e) }, true);
                        }
                    }
                }
                if (!doNotSendItem) {
            ...
            _self[_InternalConstants__WEBPACK_IMPORTED_MODULE_5__.strDoTeardown] = function () {
                _initDefaults();
            };
        });
        function _initDefaults() {
...
}(_BaseTelemetryPlugin__WEBPACK_IMPORTED_MODULE_6__.BaseTelemetryPlugin));
...
;
//# sourceMappingURL=vendors-node_modules_microsoft_1ds-core-js_dist-esm_src_Index_js.extension.js.map